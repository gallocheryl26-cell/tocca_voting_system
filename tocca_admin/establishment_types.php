...
<head>
  ...
  <title>Nature of Business | Tatak Ormoc</title>
...
<div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
            ...
            <div class="min-w-0">
              <h1 class="admin-page-title mb-2">Nature of Business</h1>
              <?php echo render_file_maintenance_breadcrumb([['label' => 'Nature of Business']]); ?>
            </div>
          </div>
          ...
          <div class="mb-3">
            <button class="btn btn-primary" id="addTypeBtn">
              <i class="bi bi-plus-lg"></i> Add Nature of Business
            </button>
          </div>
          ...
          <div class="card shadow-sm border-0 admin-table-card mb-4" id="typesCard">
            <div class="card-header bg-transparent d-flex justify-content-between align-items-center flex-wrap gap-2 py-3">
              <span class="fw-semibold mb-0"><i class="fas fa-diagram-project me-1"></i>Nature of Business</span>
            </div>
            <div class="card-body">
              <div id="typesTableWrapper" class="table-responsive">
                <table class="table table-striped table-bordered admin-data-table align-middle mb-0" id="typesTable">
                  <thead class="table-light">
                    <tr>
                      <th scope="col" style="width: 220px;">Nature of Business</th>
                    ...
                    <tr class="table-light" id="typesLoadingRow">
                      <td colspan="3" class="text-center py-5">
                        <div class="d-flex align-items-center justify-content-center gap-2 text-muted">
                          ...
                          <span>Loading natures of business...</span>
                        </div>
                      </td>
                    </tr>
                  </tbody>
              ...
              <div id="typesEmptyState" class="text-center text-muted py-5 d-none">
                ...
                <p class="mb-0">No natures of business have been configured yet.</p>
                <p class="small mb-0">Click the &ldquo;Add Nature of Business&rdquo; button to create one.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="modal fade" id="typeModal" tabindex="-1" aria-labelledby="typeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg"><div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="typeModalLabel">Add Nature of Business</h5>
      </div>
      <form id="typeForm">
        <div class="modal-body">
          <div class="mb-3">
            <label for="typeName" class="form-label">Nature of Business</label>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="saveTypeBtn">Save Nature of Business</button>
        </div>
      </form>
    </div></div>
  </div>
