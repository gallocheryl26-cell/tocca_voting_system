...
$sheets = [
    'Instructions' => [
        ...
        ['Use this workbook to load Categories, Awards, Nature of Business (sheet: Establishment Types), and Businesses (sheet: Establishments) into the active event.'],
        ...
        [''],
        ['IMPORTANT — Linking awards to nature of business'],
        ['• The Establishment Types sheet (Nature of Business in admin) is how awards get linked automatically.'],
        ['• If you import Categories + Awards only (and leave Establishment Types empty/missing), new awards will NOT'],
        ['  appear under any type on the registration form until an admin links them under File Maintenance → Nature of Business.'],
        ['• Always fill award_keys on the Establishment Types sheet so applicants see the right awards after import.'],
        ['• On the public registration form, applicants can select ONE OR MORE natures of business (checkboxes).'],
        ...
        [''],
        ['category_name'],
        ['  The award group name (e.g. Food, Service, Retail). This is NOT the nature of business.'],
        ...
        ['  This appears on the registration form as “Nature of Business” (multi-select checkboxes).'],
        [''],
        ...
        [''],
        ['3) Establishment Types (Nature of Business in admin) — one row per nature of business (REQUIRED to auto-link awards)'],
