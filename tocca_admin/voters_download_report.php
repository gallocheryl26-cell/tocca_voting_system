...
if ($format === 'excel') {
    ...
    $sh->mergeCells('A3:D3')->setCellValue('A3', $orgLine);
    ...
    $sh->mergeCells('A4:D4')->setCellValue('A4', 'Doc Ref: ' . $docRef . '   |   Generated: ' . $generatedText);
    $sh->getStyle('A4')->getFont()->setSize(9)->setItalic(true)->getColor()->setARGB('FF777777');
    $sh->getStyle('A4')->getAlignment()->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
  ...
  <table width="100%" style="font-family:sans-serif;font-size:9pt;color:#222;border-bottom:1.5px solid #0d47a1;">
    <tr>
      <td valign="middle">
        ...
        <div style="font-size:8.5pt;color:#555;">' . htmlspecialchars($orgLine, ENT_QUOTES) . '</div>
      </td>
