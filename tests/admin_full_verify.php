...
$pages = [
    ...
    'Nominations'            => 'nominations.php',
    'Events'                 => 'events.php',
    'Categories'             => 'categories.php',
    'Questions (Awards)'     => 'questions.php',
    'Establishment Types'    => 'establishment_types.php',
    'Establishments'         => 'choices.php',
    'Nomination Form'        => 'nomination_fields.php',
    'Awards Validation'      => 'award_validation_log.php',
    'Nomination Emails'      => 'communications.php',
    'QR Emails'              => 'communications_qr.php',
    'Nomination Feedbacks'   => 'nomination_feedbacks.php',
    'Voting Feedbacks'       => 'voters_feedbacks.php',
    'Nomination Reports'     => 'nomination_reports.php',
...
$apis = [
    ...
    'Nominations list'    => ['GET',  'nomination.php?action=list&event_id=7', null],
    ...
    'Nominations metrics' => ['GET',  'nominations_metrics.php', null],
